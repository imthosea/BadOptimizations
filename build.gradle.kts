...
subprojects {
	...
	dependencies {
		...
		mappings(project.the<LoomGradleExtensionAPI>().layered {
			...
			mappings(rootProject.rootDir.toPath().resolve("1.20.5.tiny").toFile())
		})
...
val jarName = "BadOptimizations-${mod_version}-1.20.5-20.6.jar"
...
publishMods {
	...
	displayName = "$mod_version (1.20.5/1.20.6)"
