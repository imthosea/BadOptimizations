...
subprojects {
	...
	dependencies {
		...
		mappings(project.the<LoomGradleExtensionAPI>().layered {
			...
			mappings(rootProject.rootDir.toPath().resolve("1.21.tiny").toFile())
		})
...
val jarName = "BadOptimizations-${mod_version}-1.21.2-21.5.jar"
...
publishMods {
	...
	displayName = "$mod_version (1.21.2-1.21.5)"
